...
%{--<div class="row">
    --}%%{--<div class="col-10" style="text-align: center; margin: 2%;margin-left: 8%">
        <i class="ti-printer" style="font-size: 9.99em;"></i>
    </div>--}%%{--
    <asset:image src="newprinter.jpg" style="height: 400px; width: 100%;"/> <br />
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-52-32.png" style="width:100%;height: 240px" />
            </div>
            <div class="carousel-item">
                <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-53-27.png" style="width:100%;height: 240px" />

            </div>
            <div class="carousel-item">
                <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-53-47.png" style="width:100%;height: 240px" />
...
<g:link controller="home" action="desktopPlatinum" style="color: blue;float: right;margin-right: 4%">To Be Continue...</g:link>
&nbsp;<div class="heading" style="font-weight:bold;color:#e25827;text-align:center;"><h3>Platinum Printer Plan</h3></div>
<div id="mobile">
