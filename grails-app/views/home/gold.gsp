    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <asset:image class="d-block img-fluid" src="screen11.jpg" style="width:100%;height: 240px" />
...
<g:link controller="home" action="mobileGold" style="color: blue;float: right;margin-right: 4%">To Be Continue...</g:link><div class="col-10" style="padding: 5%;margin-right: -18%;text-align:center;">

    <select id="selectbox" name="" onchange="javascript:location.href = this.value;" style="margin-left: 35%;width: 30%">
        <option value="#" selected>select</option>
        <option value="/Home/mobileGold">Mobile</option>
        <option value="/Home/laptopGold">Laptop</option>
        <option value="/Home/printerGold">Printer</option>
        <option value="/Home/desktopGold">Desktop</option>
