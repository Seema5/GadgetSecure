    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <asset:image class="d-block img-fluid" src="123444.jpg" style="width:100%;height: 240px" />
            </div>
...
<div class="heading" style="font-weight:bold;color:#e25827;text-align:center;"><h3>Diamond Desktop Plan</h3></div>
<div id="mobile">
