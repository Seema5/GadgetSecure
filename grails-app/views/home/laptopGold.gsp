    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <asset:image class="d-block img-fluid" src="8.png" style="width:100%;height: 240px" />
            </div>
            <div class="carousel-item">
                <asset:image class="d-block img-fluid" src="9.png" style="width:100%;height: 240px" />

            </div>
            <div class="carousel-item">
                <asset:image class="d-block img-fluid" src="10.png" style="width:100%;height: 240px" />
...
<g:link controller="home" action="printerGold" style="color: blue;float: right;margin-right: 4%">To Be Continue...</g:link>
&nbsp;<div class="heading" style="font-weight:bold;color:#e25827;text-align:center;"><h3>Gold Laptop Plan</h3></div>
<div id="mobile">
