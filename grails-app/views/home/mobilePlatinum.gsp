        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 13-55-20.png" style="width:100%;height: 240px" />
                </div>
                <div class="carousel-item">
                    <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-46-28.png" style="width:100%;height: 240px" />

                </div>
                <div class="carousel-item">
                    <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-49-57.png" style="width:100%;height: 240px" />
...
<g:link controller="home" action="laptopPlatinum" style="color: blue;float: right;margin-right: 4%">To Be Continue...</g:link>
&nbsp;<div class="heading" style="font-weight:bold;color:#e25827;text-align:center;"><h3>Platinum Mobile Plan</h3></div>
<div id="mobile">
