...
<body>
    ...
    %{--<asset:image src="newdesktop.jpg" style="height: 305px; width: 100%;"/> <br />--}%
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-54-08.png" style="width:100%;height: 240px" />
                </div>
                <div class="carousel-item">
                    <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-54-34.png" style="width:100%;height: 240px" />

                </div>
                <div class="carousel-item">
                    <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-54-49.png" style="width:100%;height: 240px" />
                </div>
                <div class="carousel-item">
...
&nbsp;<div class="heading" style="font-weight:bold;color:#e25827;text-align:center;"><h3>Platinum Desktop Plan</h3></div>
