...
<body>
%{--<div class="row">
    --}%%{--<div class="col-10" style="text-align: center; margin: 2%;margin-left: 8%">
        <i class="ti-desktop" style="font-size: 9.99em;"></i>
    </div>--}%%{--
    <asset:image src="newlappy.jpg" style="height: 305px; width: 100%;"/> <br />
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-50-49.png" style="width:100%;height: 240px" />
            </div>
            <div class="carousel-item">
                <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-51-10.png" style="width:100%;height: 240px" />

            </div>
            <div class="carousel-item">
                <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-51-38.png" style="width:100%;height: 240px" />

            </div>
            <div class="carousel-item">
                <asset:image class="d-block img-fluid" src="Screenshot from 2018-03-13 14-51-59.png" style="width:100%;height: 240px" />
...
<g:link controller="home" action="printerPlatinum" style="color: blue;float: right;margin-right: 4%">To Be Continue...</g:link>
&nbsp;<div class="heading" style="font-weight:bold;color:#e25827;text-align:center;"><h3>Platinum Laptop Plan</h3></div>
<div id="mobile">
    <div class="row" style="margin-top: 3%;margin-bottom: 3%">
        ...
        <g:link controller="home" action="platinum" class="btn btn-success btn-green" style="margin-bottom: 10px;padding-right: 10px;padding-left: 10px;color: black;border: 1px solid #e258277a;border-radius:5px;margin-left: 91% ">Back</g:link>
    </div>
