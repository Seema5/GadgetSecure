...
<html>
<head>
    <meta name="layout" content="customLayout"/><title></title>
</head>
    ...
    <form>
        <table class="table" align="center" style="width: 40%;">
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="password" size="35%" class="form-control" id="password" placeholder="Enter Password">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="password" name="cnpassword" size="35%" class="form-control" id="cnpassword" placeholder="Retype Password">
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <p align="center"> <button class="btn btn-success btn-green"  style="margin-bottom: 10px;padding-right: 10px;padding-left: 10px;color: black;    border: 1px solid #e258277a;border-radius:5px ">Register</button></p>
                </td>
            </tr>
        </table>
    </form>
